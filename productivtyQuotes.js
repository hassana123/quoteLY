let productivityQuotes =[
    ...
    "f we all did the things we are capable of doing, we would literally astound ourselves.",
    ...
    "Successful people are simply those with succesful habits",
    ...
    "Don’t be afraid of making mistakes, who doesn’t take risks, never wins.",
...
function getRandomQuotes(){
    ...
    let rand = Math.floor(productivityQuotes.length*Math.random());
    quote.innerText = `${productivityQuotes[rand]}`;
