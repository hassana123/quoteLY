const inspirationalQuotes = [
    ...
    "When we let fear be our master, we cannot be happy and free as a butterfly. But when we choose to trust the journey and embrace love and joy, we are free to fly.When we let fear be our master, we cannot be happy and free as a butterfly. But when we choose to trust the journey and embrace love and joy, we are free to fly.",
...
function getRandomQuotes(){
    ...
    let rand = Math.floor(inspirationalQuotes.length*Math.random());
    quote.innerText = `${inspirationalQuotes[rand]}`;
